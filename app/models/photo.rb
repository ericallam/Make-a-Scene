...
class Photo < ActiveRecord::Base
  ...
  has_attached_s3_file :image, :styles => { 
    ...
    :big => { :geometry => "x400>", :watermark_path => "#{Rails.root}/public/images/watermark_big.png", :position => 'south', :processors => [:watermark] }, 
    :album => { :geometry => "80x80#", :processors => [:thumbnail] }, 
    :external => { :geometry => "90%" , :watermark_path => "#{Rails.root}/public/images/watermark_external.png", :position => 'south', :processors => [:watermark] }
